...
enum pcbnew_ids
{
    ...
    ID_POPUP_PCB_TEARDROP_SIZE_LENGTH_LAST = ID_POPUP_PCB_TEARDROP_SIZE_LENGTH_FIRST + 19,
    ID_POPUP_PCB_TEARDROP_SIZE_WIDTH_FIRST,
    ID_POPUP_PCB_TEARDROP_SIZE_WIDTH_LAST = ID_POPUP_PCB_TEARDROP_SIZE_WIDTH_FIRST + 19,
